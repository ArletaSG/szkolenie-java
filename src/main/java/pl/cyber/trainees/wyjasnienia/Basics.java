...
//Utworzyć metodę, której zadaniem jest wyświetlenie tekstu podanego jako parametr
    ...
    public Basics() { } //konstruktor bez parametru
    public Basics(final String tekst) { //konstruktor 1 parametr
...
//    System.out.println("Wyświetl tekst");
    ...
    public void wyswietlTekstSuma(String txt1, String suma){
        System.out.println(txt1 + suma);
